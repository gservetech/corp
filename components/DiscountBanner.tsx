              ...
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row items-center">
                  <div className="flex-1 p-6 md:px-12 flex flex-col gap-2 md:gap-4">
                    ...
                    <p className="mb-2">Use code: <span className="font-semibold text-primary uppercase">{sale?.couponCode}</span> for {" "} <span className="font-semibold text-primary uppercase">{sale?.discountAmount}%</span> OFF</p>
